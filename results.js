...
var url = "https://cocohub.cc/api/" // URL to query the PyBossa API
var xhr = $.getJSON(url + "app?short_name={{language}}"); // In this case Flickr Person
var app_id;
